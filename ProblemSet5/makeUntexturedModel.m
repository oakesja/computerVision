% makeUntexturedModel
%
% Creates an untextured vrml file.
%
% Usage:  makeUntexturedModel(filename, X, polygons, rotation, scale)
% 
% Arguments:
...
%
function makeUntexturedModel(filename, X, polygons, rotation, scale);
...
fprintf(fd, ' title "Untextured model"\n');
fprintf(fd, '}\n\n');
